    ...
    while(n-- > 0)
    {
        ...
        if ( u1 == '%' ) // easier/safer than scanf
        {
            ...
            if ( CROW_QS_ISHEX(unyb) && CROW_QS_ISHEX(lnyb) )
                u1 = static_cast<unsigned char>((CROW_QS_HEX2DEC(unyb) * 16) + CROW_QS_HEX2DEC(lnyb));
            else
                u1 = '\0';
        }
        ...
        if ( u2 == '%' ) // easier/safer than scanf
        {
            ...
            if ( CROW_QS_ISHEX(unyb) && CROW_QS_ISHEX(lnyb) )
                u2 = static_cast<unsigned char>((CROW_QS_HEX2DEC(unyb) * 16) + CROW_QS_HEX2DEC(lnyb));
            else
                u2 = '\0';
        }
...
inline int qs_decode(char * qs)
{
    ...
    while( CROW_QS_ISQSCHR(qs[j]) )
    {
        ...
        else if ( qs[j] == '%' ) // easier/safer than scanf
        {
            ...
            qs[i] = static_cast<char>((CROW_QS_HEX2DEC(qs[j+1]) * 16) + CROW_QS_HEX2DEC(qs[j+2]));
            j+=2;
        }
        else
        {
...
namespace crow 
{
    ...
    public:
        ...
        query_string& operator = (query_string&& qs)
        {
            ...
            {
                p = const_cast<char*>(p + (const_cast<char*>(url_.c_str()) - old_data));
            }
            return *this;
        }
